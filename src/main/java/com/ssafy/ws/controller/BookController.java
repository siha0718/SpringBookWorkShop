...
public class BookController {
	...
	@PostMapping("/login")
	public String dologin(User user, HttpSession session, Model model) throws Exception {
...
//		}
		...
		User userRes = userService.searchById(user);
	...
	@PostMapping("/regist")
	public String doRegist(@ModelAttribute Book book, @RequestPart(required = false) MultipartFile file , Model model) throws Exception {
	...
	public String showErrorCommonerr() {
